...
function Contact() {
  const { Phone, Mail, MapPin } = SDIcons;
      ...
      <div className="container">
        <div className="section-header">
          <div className="lhs">
            ...
            <h2>Tell us about<br/>your car.</h2>
          </div>
          <p>We respond inside of 4 business hours. Detailed quotes
             are no-obligation and usually land same-day.</p>
        </div>

        <div className="contact-wrap">
          <aside className="contact-info">
            <div className="block">
              <span className="label"><Phone width="12" height="12" style={{ verticalAlign: '-2px', marginRight: 6 }} />Call</span>
              <div className="val">(555) 284·0199</div>
              <div className="sub">Mon – Sat · 08:00 – 18:00 CT</div>
            </div>
            <div className="block">
              <span className="label"><Mail width="12" height="12" style={{ verticalAlign: '-2px', marginRight: 6 }} />Email</span>
              <div className="val" style={{ fontSize: 22 }}>hello@smartdetailing.co</div>
              <div className="sub">We reply within 4 business hours.</div>
            </div>
            <div className="block">
              <span className="label"><MapPin width="12" height="12" style={{ verticalAlign: '-2px', marginRight: 6 }} />Studio</span>
          ...
          <form className="contact-form" onSubmit={onSubmit}>
            <label>
              ...
              <input type="text" required placeholder="Alex Morrison" />
            </label>
            <label>
            ...
            <label>
              ...
              <input type="text" placeholder="2023 Audi RS6" />
            </label>
            <label>
            ...
            <label className="full">
              ...
              <textarea placeholder="Year, model, color, current condition, what you'd like done." />
            </label>
            <div className="submit-row">
              <span className="agree">We'll never share your info. Reply within 4 hours.</span>
